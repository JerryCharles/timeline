...
export default async function EnglishHome({
  ...
  return (
    <>
      <Navbar />
      <main className="flex min-h-screen flex-col items-center p-6 md:p-8 bg-gray-50 dark:bg-gray-900">
        <div className="w-full max-w-7xl mx-auto">
          <h1 className="text-2xl md:text-3xl font-bold mb-8 text-gray-900 dark:text-white">Timeline Topics</h1>
